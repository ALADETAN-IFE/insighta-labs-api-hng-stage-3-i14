...
- 🗝️ GitHub OAuth with PKCE, for both the CLI and the browser
- 🔑 Access + refresh token management with short expiry windows
- 🛡️ Role-based access control — admin and analyst, enforced across every endpoint
- 🗂️ API versioning and an updated pagination shape
- 📤 CSV profile export
...
**[TECHNICAL REQUIREMENTS DOCUMENT](https://docs.google.com/document/d/1pZrRnC_eJzYK1TvDg6IAVSN-f4thICmbS7yCQRDIc5A/edit?tab=t.0#heading=h.pnbq4h4oxc8y)**  
**[AIRTABLE LINK](https://airtable.com/appZPpwy4dtvVBWU4/shrMH9P1zv4TPhvns?C3OrT=recLosSexjKl0FXZL)**

**SUBMISSION:** Run `/submit` in stage-3-backend and submit the requested URLs

**Deadline:** April 29, 2026, 11:59pm.

And no, we are not extending it. 🦇
